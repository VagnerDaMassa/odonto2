...
<div class="card mb-3">
  <img src="../img/dentista2.png" class="card-img-top" alt="..." height= 55%>
	...
	<div class="text-center" >
			<h1 class="text-info" align="center">Perfil Do Usuario</h1>
		</div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="validationDefaultUsername" placeholder="EX:AdmOdonto@gmail.com" aria-describedby="inputGroupPrepend2" disabled>
      </div>
    </div>
