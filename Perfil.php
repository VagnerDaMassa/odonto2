...
<div class="card mb-3">
  <img src="../img/dentista2.png" class="card-img-top" alt="..." height= 55%>
	...
	<div class="text-center" >
			<h1 class="text-info" align="center">Perfil Do Funcionario</h1>
		</div>
...
<div class="container" style="margin-top: 60px">
	...
	<div><img src="../img/buzzlighummm.png" alt="..." class="img-thumbnail" width="150">
	<h3 class="text-info">João Correia</h3></div>
...
<form>
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault01" placeholder="EX:João"  disabled>
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Sobrenome</label>
      <input type="text" class="form-control" id="validationDefault02" placeholder="EX:Correia" disabled>
    </div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault01" placeholder="EX:Administrador" disabled>
    </div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault01" placeholder="EX:01/01/2001" disabled>
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Usuario</label>
      <input type="text" class="form-control" id="validationDefault02" placeholder="EX:Josisvaldo" disabled>
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">RG/CPF</label>
      <input type="text" class="form-control" id="validationDefault02" placeholder="EX:111.111.111-11" disabled>
    </div>
    ...
    <button type="button" class="btn btn-success">Modifique seu Registro</button>
