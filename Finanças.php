...
<div class="card mb-3">
  <img src="../img/dentista2.png" class="card-img-top" alt="..." height= 55%>
	...
	<div class="col-sm-12 text-center" >
			<h1 class="text-info" align="center">Balanço:</h1>
		</div>
...
<div class="container" style="margin-top: 60px">
	...
	<p align="center"><strong>Aqui sera balanceado as finanças nos ultimos 3 anos!!!siga a tabela abaixo:</strong></p>
	
	<hr>

	<div class="col-sm-12 text-center" >
			<h3 class="text-info">Finanças dos ultimos 3 anos:</h3>
		</div>
